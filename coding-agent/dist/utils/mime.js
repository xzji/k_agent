...
var FILE_TYPE_SNIFF_BYTES = 4100;
function detectSupportedImageMimeTypeFromFile(filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var fileHandle, buffer, bytesRead, fileType;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, , 5, 7]);
                    buffer = Buffer.alloc(FILE_TYPE_SNIFF_BYTES);
                    return [4 /*yield*/, fileHandle.read(buffer, 0, FILE_TYPE_SNIFF_BYTES, 0)];
                case 3:
                    bytesRead = (_a.sent()).bytesRead;
                    if (bytesRead === 0) {
                        return [2 /*return*/, null];
                    }
                    return [4 /*yield*/, (0, file_type_1.fileTypeFromBuffer)(buffer.subarray(0, bytesRead))];
                case 4:
                    fileType = _a.sent();
                    if (!fileType) {
                        return [2 /*return*/, null];
